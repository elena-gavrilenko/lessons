...
// form.classList.add('create-user-form');//или form.className('create-user-form')
...
//     tegMain.textContent=textTegMain;//или innerText
...
//     btn.innerText=text;
//     btn.setAttribute('type',type);//или btn.type='submit'
//     return btn;
// }
...
//или через запятую, присвоив эти функции переменным
