...
// innerText покаывает тект только видимых элементов
...
// зазбивает по тегам
// card.insertAdjacentHTML('afterbegin','<p>Hello from afterbegin</p>');//после щткрывающего тега
// card.insertAdjacentHTML('afterend','<p>Hello from afterend</p>');//после акрывающего тега


// card.insertAdjacentText('beforebegin','<p>Hello from beforebegin</p>');//перед открывающимся тегом
// card.insertAdjacentText('beforeend','<p>Hello from beforeend</p>');//перед акрывающимся тегом
