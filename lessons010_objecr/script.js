...
//     ...obj2
// }
//2) метод для копировния obj.assigh
// const obj3={};
// Object.assign(obj3,obj,obj2);
// console.log(obj3);

//  если есть одинаковые поля возьмет последнее
...
// Если ключ это функция то она называется метод
// -----------------------------------------------------
// запись
// const obj={
//     myProperty:1000,
...
// hasOwnProerty - проверить есть ли ключ в оъекте
...
// }
// чтобы определить доину объекта нужно получить массив ключей и определить его длину через length


// деструктуризация массива(или деструктурирующее )
// ----------------------------------------------------
...
// THIS
// --------------------------------------------
// this - контекст вызова, груба ссылка на то, где мы находимся
