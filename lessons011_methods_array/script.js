...
//     ];
// 1)
// let newArray1=matrix.reduce((acc,el)=>acc.concat(el),[]);
// console.log(newArray1);
// 2)
// let newArray=[];
// matrix.forEach(el=>newArray=newArray.concat(el));
// console.log(newArray);
// 3)
// console.log([].concat(...matrix));
// 4)
// let newArray1=matrix.reduce((acc,el)=>[...acc,...el],[]);
// console.log(newArray1);
// 12)
// const student = {
//     fullName: 'Максим',
