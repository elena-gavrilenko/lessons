...
const book4=new Book('Влади­мир Набоков','Лолита',448);
const book5=new Book('Уильям Фолкнер','Шум и ярость',608);
const book6=new Book('Ральф Эллисон','Неви­димка',399);
const book7=new Book('Вир­джи­ния Вульф','К маяку',288);
const book8=new Book('Гомер','Иллиада и Одиссея',1304);

let books=Array.of(book1,book2,book3,book4,book5,book6,book7,book8);

function getBiggerBook(arr){
  arr.sort(el=>el.pageAmount);
  return arr[0]
}