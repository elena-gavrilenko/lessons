...
//       item.isOnSale = true;
//       item.setPriceOfProduct() = item.getPriceOfProduct * (100 - discountPercent) * 0.01;
//     });
//   }
...
//     if (needItem && needItem.amount>0) {needItem.amount--;}
//     else {
//       throw new Error
//     }}
   
//    needItem ? (this.totalProfit += needItem.price) : this.totalProfit;
